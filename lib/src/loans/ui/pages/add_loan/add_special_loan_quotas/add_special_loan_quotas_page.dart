...
import 'package:loands_flutter/src/loans/ui/pages/add_loan/add_special_loan_quotas/add_special_loan_quotas_controller.dart';
import 'package:loands_flutter/src/utils/core/strings.dart';
import 'package:loands_flutter/src/utils/ui/widgets/quota_widget.dart';
import 'package:utils/utils.dart';

class AddSpecialLoanQuotasPage extends StatelessWidget {
  AddSpecialLoanQuotasPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AddSpecialLoanQuotasController>(
        init: controller,
        id: pageIdGet,
  ...
  Widget _detailQuotas({
    ...
    List<Widget> quotas = [];
    int i = 1;
    quotas.addAll(controller.quotas.map((e) {
      return QuotaWidget(
        value: i++,
        size: size,
